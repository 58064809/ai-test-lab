...
- 已新增 MCP 规划文档：
  - `docs/integrations/mcp-selection.md`
  - `docs/integrations/mcp-security-policy.md`
- 已新增 filesystem_read 设计与策略模型：
  - `docs/runtime/filesystem-read-design.md`
...
- 已新增成熟 filesystem MCP 选型与最小接入验证方案：
  - `docs/integrations/filesystem-mcp-selection.md`
  - `docs/integrations/filesystem-mcp-minimal-integration-plan.md`
- 已新增官方 filesystem MCP quickstart 与最小配置模板：
  - `docs/integrations/filesystem-mcp-quickstart.md`
  - `configs/mcp/filesystem-server.example.json`
- 已在 `configs/registry/tools.yaml` 中补充后续 planned MCP 工具规划：
  - `filesystem_mcp_read`
  - `filesystem_write`
  - `github_read`
  - `github_write`
