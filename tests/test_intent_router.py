...
def test_rules_loader_loads_required_intents() -> None:
    config = IntentRulesLoader.load("configs/routing/intents.yaml")
...
@pytest.mark.parametrize(
    ...
    [
        ("请做需求分析", "requirement_analysis", "skills/requirement-analysis/SKILL.md"),
        ("根据这个需求生成测试用例", "test_case_generation", "skills/test-case-generation/SKILL.md"),
        ("请基于OpenAPI设计接口测试方案", "api_test_design", "skills/api-testing/SKILL.md"),
        ("请设计UI自动化页面回归方案", "ui_test_design", "skills/ui-automation/SKILL.md"),
        ("请运行pytest并分析allure结果", "pytest_execution", "references/tooling/qa-automation/pytest-allure.md"),
        ("请运行 pytest", "pytest_execution", "references/tooling/qa-automation/pytest-allure.md"),
        ("分析这段报错日志", "log_analysis", "skills/log-analysis/SKILL.md"),
        ("请整理缺陷报告和复现步骤", "bug_report", "skills/bug-report/SKILL.md"),
        ("请做 code review", "code_review", "待接入：代码评审工作流"),
        ("请修改文件并修复路径引用", "repo_file_change", "待接入：仓库改动工作流"),
        ("请调研 Schemathesis 接入方式", "tool_research", "references/tooling/sources.md"),
        ("请读取 README 并分析项目状态", "tool_research", "references/tooling/sources.md"),
        ("读取 README 并分析项目状态", "tool_research", "references/tooling/sources.md"),
        ("结合 README 分析项目状态", "tool_research", "references/tooling/sources.md"),
        ("请记住并保存偏好", "memory_update", "src/ai_test_assistant/memory/MODULE.md"),
        ("请更新工作流并修改模板", "workflow_update", "skills/defect-analysis/SKILL.md"),
    ],
)
def test_routes_all_required_intents_from_clear_requests(
    ...
    router = IntentRouter.from_rules_file("configs/routing/intents.yaml")
    ...
    assistant_config.write_text(
        "\n".join(
            [
                ...
                "  sqlite_path: .assistant/memory.sqlite3",
                "intent:",
                "  rules_path: configs/routing/intents.yaml",
            ]
        ),
        encoding="utf-8",
    )
