...
```text
阅读 AGENTS.md，根据 prompts/test-case-generation.md，为这个需求生成测试用例。
```

```text
阅读 workflows/api-test-workflow.md，基于当前 OpenAPI 文档设计接口测试方案。
```

```text
阅读 tools/schemathesis.md，判断当前项目是否适合接入 Schemathesis，并给出验证步骤。
```
